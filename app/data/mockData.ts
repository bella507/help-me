...
export const mockHelpRequests = [
  {
    ...
    urgency: 'high',
    description:
      'ครอบครัว 5 คน ไม่มีอาหารและน้ำดื่ม น้ำท่วมสูงไม่สามารถออกจากบ้านได้',
  ...
  },
  {
    ...
    urgency: 'high',
    description:
      'น้ำท่วมบ้านสูง 1.5 เมตร มีผู้สูงอายุติดเตียง 1 คน ต้องการความช่วยเหลือด่วน',
    status: 'pending' as const,
  ...
  },
  {
    ...
    urgency: 'low',
    description:
      'เสื้อผ้าเปียกหมด ต้องการเสื้อผ้าเปลี่ยนสำหรับครอบครัว มีเด็กเล็ก 2 คน',
    status: 'pending' as const,
  ...
  },
  {
    ...
    urgency: 'medium',
    description:
      'ครอบครัวใหญ่ 12 คน ต้องการอาหารและน้ำดื่ม มีเด็กทารก 3 คน ต้องการนมผง',
    status: 'in-progress' as const,
...
export const mockNews = [
  {
    ...
    content:
      'กรมอุตุนิยมวิทยาเตือน 5 จังหวัดภาคกลางเสี่ยงน้ำท่วมฉับพลัน ได้แก่ นนทบุรี ปทุมธานี พระนครศรีอยุธยา สิงห์บุรี และอ่างทอง เนื่องจากฝนตกหนักต่อเนื่อง ขอให้ประชาชนเตรียมพร้อมรับสถานการณ์ และติดตามข่าวสารอย่างใกล้ชิด',
    type: 'warning',
  ...
  },
  {
    ...
    content:
      'จังหวัดนนทบุรีเปิดศูนย์พักพิงผู้ประสบอุทกภัยเพิ่มเติม 3 แห่ง ได้แก่ โรงเรียนวัดบางกระสอ โรงเรียนบ้านบางเลน และหอประชุมอำเภอบางกรวย พร้อมรองรับผู้ประสบภัยได้รวมกว่า 500 คน มีอาหาร น้ำดื่ม และเครื่องนอนเพียงพอ',
    type: 'update',
    createdAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    urgent: false,
  },
  {
    ...
    content:
      'ศูนย์ช่วยเหลือผู้ประสบภัยจะทำการแจกถุงยังชีพให้แก่ผู้ประสบภัยในวันที่ 25 พฤศจิกายน 2567 เวลา 09:00-16:00 น. ณ โรงเรียนวัดบางกระสอ และศาลาอเนกประสงค์อำเภอบางกรวย โดยผู้ที่ได้รับความเดือดร้อนสามารถนำบัตรประชาชนมาขึ้นทะเบียนรับถุงยังชีพได้',
    type: 'info',
    createdAt: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(),
    urgent: false,
  },
  {
    ...
    content:
      'กรมชลประทานรายงานว่าระดับน้ำในเขื่อนเจ้าพระยาและป่าสักชลสิทธิ์เริ่มลดลงแล้ว คาดว่าสถานการณ์น้ำท่วมจะคลี่คลายภายใน 3-5 วัน แต่ยังคงต้องติดตามสถานการณ์อย่างใกล้ชิด เนื่องจากยังมีพื้นที่ลุ่มที่ระบายน้ำไม่ทัน',
    type: 'update',
  ...
  },
  {
    ...
    content:
      'ศูนย์ช่วยเหลือผู้ประสบภัยเปิดรับบริจาคเสื้อผ้าและผ้าห่มสำหรับผู้ประสบภัย โดยสามารถนำมาส่งได้ที่ศาลาว่าการจังหวัดนนทบุรี หรือที่ศูนย์พักพิงทั้ง 3 แห่ง ในเวลา 08:00-18:00 น. ทุกวัน',
    type: 'info',
  ...
  },
  {
    ...
    content:
      'กรมควบคุมโรคแจ้งเตือนให้ผู้ประสบภัยระวังโรคติดต่อหลังน้ำท่วม เช่น โรคท้องร่วง โรคผิวหนัง และโรคไข้เลือดออก แนะนำให้ดื่มน้ำสุก กินอาหารปรุงสุก และรักษาความสะอาดร่างกาย หากมีอาการป่วยให้รีบไปพบแพทย์ทันที',
    type: 'warning',
...
export const mockFAQs = [
  {
    ...
    answer:
      'สามารถขอความช่วยเหลือได้ผ่านแบบฟอร์มในหน้า "ขอความช่วยเหลือ" หรือโทร 1784 (24 ชม.) เจ้าหน้าที่จะติดต่อกลับภายใน 30 นาที',
    category: 'general',
  },
  {
    id: 'faq002',
    ...
    answer:
      'ศูนย์พักพิงมีน้ำดื่ม อาหาร เครื่องนอน ห้องน้ำ ไฟฟ้า และแพทย์ประจำ สามารถพาสัตว์เลี้ยงได้ในบางศูนย์',
    category: 'shelter',
  },
  {
    id: 'faq003',
    ...
    answer:
      'ควรนำบัตรประชาชน เอกสารสำคัญ ยา และเสื้อผ้าเปลี่ยน ศูนย์มีอุปกรณ์พื้นฐานให้แล้ว',
    category: 'shelter',
  },
  {
    id: 'faq004',
    ...
    answer:
      'สามารถบริจาคได้ที่ศาลาว่าการจังหวัด ศูนย์พักพิง หรืออำเภอ เวลา 08:00-18:00 น. ทุกวัน',
    category: 'donation',
  },
  {
    id: 'faq005',
    ...
    answer:
      'โทร 1669 หรือแจ้งผ่านแบบฟอร์มขอความช่วยเหลือ เลือกประเภท "การรักษาพยาบาล" เจ้าหน้าที่จะจัดส่งให้โดยเร็ว',
    category: 'medical',
  },
  {
    id: 'faq006',
    ...
    answer:
      'ได้ครับ ศูนย์พักพิงส่วนใหญ่รองรับสัตว์เลี้ยง แต่ต้องอยู่ในกรง/สายจูง และมีใบรับรองวัคซีน',
    category: 'pets',
  },
  {
    id: 'faq007',
    ...
    answer:
      'ไปที่เมนู "ติดตามสถานะ" แล้วใส่เบอร์โทรศัพท์ที่ใช้ขอความช่วยเหลือ ระบบจะแสดงสถานะปัจจุบัน',
    category: 'general',
  },
  {
    id: 'faq008',
    ...
    answer:
      'มีครับ โทร 1784 แจ้งความประสงค์ เจ้าหน้าที่จะส่งรถไปรับตามจุดนัดหมาย',
    category: 'transport',
  },
  {
    id: 'faq009',
    ...
    answer:
      'กรอกแบบฟอร์มในหน้า "อาสาสมัคร" เจ้าหน้าที่จะติดต่อกลับภายใน 24 ชม. เพื่อยืนยันและนัดปฐมนิเทศ',
    category: 'volunteer',
  },
  {
    id: 'faq010',
    ...
    answer:
      'ตามการคาดการณ์ของกรมชลประทาน สถานการณ์จะดีขึ้นภายใน 3-5 วัน แต่ต้องติดตามข่าวสารอย่างใกล้ชิด',
    category: 'general',
  },
];
